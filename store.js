...
function ShowResult1(){
  ...
  window.alert('Item has been added, Please scroll down to finish your purchase');
    ...
    window.alert('please select quantity that is allowed');
  }
...
function mean() {
  window.alert("Total Cost : $ " + sTotal);
  window.alert(" Thank you for your purchase! have a good day! ");
  location.href = "index.html";
}
function kind() { 
  var Ft = sTotal * 1.15;
  window.alert("Total Cost : $ " + Ft.toFixed(2));
  window.alert(" Thank you for your purchase! have a good day! ");
  location.href = "index.html";
}
function veryKind() {
